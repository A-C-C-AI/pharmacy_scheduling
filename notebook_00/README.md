...
Open `00_data_cleaning_pseudonymization_canonicalization_v2.ipynb` to read the executed notebook. Each code cell has one title; executable logic is unchanged from the verified project.
...
- `pseudonymized_assignments.csv`
- `observed_data_profile.json`
- `mapping_PRIVATE.csv`
- `excluded_non_rotation_PRIVATE.csv`
- `stage_00_manifest.json`
