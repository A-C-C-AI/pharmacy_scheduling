...
Open `02_constraint_specification_v2.ipynb` to read the executed notebook. Each code cell has one title; executable logic is unchanged from the verified project.
...
- `secondary_eligibility_evidence.csv`
- `policy_justifications.csv`
- `stage_02_manifest.json`
