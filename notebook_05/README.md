...
Open `05_explainability_final_comparison_v2.ipynb` to read the executed notebook. Each code cell has one title; executable logic is unchanged from the verified project.
...
- `nt_change_explanation.csv`
- `scenario_pareto_comparison.csv`
- `final_validation_checklist.csv`
- `final_project_evidence.json`
